...
- Cadastro de horários em um dia de aula com **hora de início + duração em minutos** (padrão: 50 min).
- Calendário padrão inicial e recorrência configurável para 1 ou várias semanas.
- Montagem do calendário por dia exibindo os intervalos calculados automaticamente (início + duração).
